...
![Sylvia the Statistical Squirrel](./img/sylvia-square-transparent.png){ width="300", align="right" }
...
- Over **250,000 students** take the AP Statistics exam each year[^1]
- AP Statistics has grown faster than almost any other AP subject over the past decade
- Approximately **1.5 million college students** enroll in introductory statistics courses annually[^2]
...
[^2]: American Statistical Association. [Statistics Education Research](https://www.amstat.org/education/guidelines-for-assessment-and-instruction-in-statistics-education-(gaise)-reports). GAISE Reports.

[^3]: OpenStax. [The cost of traditional textbooks](https://openstax.org/). Note that introductory statistics texts from major publishers typically range from $150-$250.
