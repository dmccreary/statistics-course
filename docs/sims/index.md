---
title: List of MicroSims for AP Statistics
description: A list of all the interactive MicroSims used in the AP Statistics course
hide:
  - toc
---
...
-   **[Association Strength Spectrum](./association-strength-spectrum/index.md)**
    ...
    ![Association Strength Spectrum](./association-strength-spectrum/association-strength-spectrum.png)
...
-   **[Discrete vs Continuous Number Line](./discrete-continuous-numberline/index.md)**
    ...
    ![Discrete vs Continuous Number Line](./discrete-continuous-numberline/discrete-continuous-numberline.png)
...
-   **[Distribution Shape Gallery](./distribution-shape-gallery/index.md)**
    ...
    ![Distribution Shape Gallery](./distribution-shape-gallery/distribution-shape-gallery.png)
...
-   **[Hypothesis Testing Decision Flowchart](./hypothesis-testing-flowchart/index.md)**
    ...
    ![Hypothesis Testing Decision Flowchart](./hypothesis-testing-flowchart/hypothesis-testing-flowchart.png)
...
-   **[Parameter vs Statistic Comparison](./parameter-statistic-compare/index.md)**
    ...
    ![Parameter vs Statistic Comparison](./parameter-statistic-compare/parameter-statistic-compare.png)
...
-   **[Population and Sample Visualization](./population-sample-visual/index.md)**
    ...
    ![Population and Sample Visualization](./population-sample-visual/population-sample-visual.png)
...
-   **[Stemplot Constructor](./stemplot-constructor/index.md)**
    ...
    ![Stemplot Constructor](./stemplot-constructor/stemplot-constructor.png)
...
-   **[Symmetric Distribution Identifier](./symmetric-distribution/index.md)**
    ...
    ![Symmetric Distribution Identifier](./symmetric-distribution/symmetric-distribution.png)
...
-   **[Test Statistic Calculator](./test-statistic-calculator/index.md)**
    ...
    ![Test Statistic Calculator](./test-statistic-calculator/test-statistic-calculator.png)
...
-   **[Type I and Type II Error Visualizer](./type-error-visualizer/index.md)**
    ...
    ![Type I and Type II Error Visualizer](./type-error-visualizer/type-error-visualizer.png)
