...
| Glossary Terms | 295 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 80 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 190 | - | Questions across all chapters |
| MicroSims | 109 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
|-------------|-------------|---------------|-------|
| Diagrams | 96 | 96 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 1 | LaTeX expressions (inline and display) |
| Total Words | 220,102 | 133,168 | Words in markdown files |
| Links | 672 | 132 | Hyperlinks in markdown format |
| Equivalent Pages | 958 | 611 | Estimated pages (250 words/page + visuals) |
